...
save_name_data_csv = ''.join(['BrightBandsXNARR_v6_r_5_time0.5x15.0pcntx25.0_withrhohv_0.910.97_',dir,'.csv'])
save_name_fig = ''.join(['BrightBandsXNARR_v6_r_5_time0.5x15.0pcntx25.0_withrhohv_0.910.97_',dir,'.png'])
