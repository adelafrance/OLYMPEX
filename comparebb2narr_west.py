...
bb_data = ''.join(['brightbandsfound_v6_r_6_time0.25x15.0pcntx25.0_withrhohv_0.910.97_',dir,'.npy'])
NARR_data = 'NARR_at_NPOL.csv'
save_name_data_csv = ''.join(['BrightBandsXNARR_v6_r_6_time0.25x15.0pcntx25.0_withrhohv_0.910.97_',dir,'.csv'])
save_name_fig = ''.join(['BrightBandsXNARR_v6_r_6_time0.25x15.0pcntx25.0_withrhohv_0.910.97_',dir,'.png'])
